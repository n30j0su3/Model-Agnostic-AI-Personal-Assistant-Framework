...
1. Marca el item del backlog como "En Progreso" usando `tools/backlog_manager.py`.
2. Implementa el cambio.
3. Actualiza documentacion relevante.
4. Marca el item como "Hecho" y agrega entrada al historial.
5. Si aplica, propone version SemVer.
6. Si hay deploy o commit solicitado, coordina con `@github-deployer` y pide aprobacion explicita.
