...
def main():
    ...
    parser.add_argument("--threshold", type=int, default=2, help="Umbral para delegacion implicita")
    parser.add_argument("--explain", action="store_true", help="Incluir explicacion")
    parser.add_argument("--list-rules", action="store_true", help="Listar reglas locales")
    parser.add_argument("--list-agents", action="store_true", help="Listar agentes y keywords")
