...
## Inherits
Read and apply: .context/MASTER.md

## Tool Configuration
- Primary model: Claude Sonnet (via Anthropic)
- Fallback: Gemini 1.5 Pro
- Code generation: On
- File editing: Allowed with confirmation

## Active Skills
[pending initialization]

## Custom Instructions
- Utiliza la estructura de directorios del proyecto para organizar la información.
- Mantén la trazabilidad en sessions/SESSION.md.
- Sigue los estándares definidos en plan-trabajo-v0.md.
